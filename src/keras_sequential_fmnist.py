# -*- coding: utf-8 -*-
"""Keras - Sequential - fmnist

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_j4yxov2trBrB0TZYVEU_S4kK4lzG6bW
...
# evaluer le modele sur la partie train
eval_train = model.evaluate(train_images, train_labels)
# evaluer le modele sur la partie test
eval_test = model.evaluate(test_images, test_labels)
